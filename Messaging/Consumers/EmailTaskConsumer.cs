...
public sealed class EmailTaskConsumer : BackgroundService
{
    private readonly RabbitMqSettings _settings;
    private readonly IServiceScopeFactory _scopeFactory;

    public EmailTaskConsumer(RabbitMqSettings settings, IServiceScopeFactory scopeFactory)
    {
        _settings = settings;
    ...
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        await channel.QueueBindAsync(
            queue: RabbitMqSettings.EmailQueue,
            exchange: RabbitMqSettings.Exchange,
            routingKey: RabbitMqSettings.EmailRoutingKey,
            cancellationToken: cancellationToken);
        ...
        consumer.ReceivedAsync += async (_, eventArgs) =>
        {
            ...
            try
            {
                ...
                Console.WriteLine($"Processando task de email {message.TaskId}...");
                ...
                Console.WriteLine($"Task de email {message.TaskId} concluída.");
            }
        ...
        Console.WriteLine(
            $"Email consumer aguardando mensagens em {RabbitMqSettings.EmailQueue}...");
